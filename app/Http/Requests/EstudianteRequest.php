...
class EstudianteRequest extends Request
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            //
            'nombres_pa1'      => 'regex:/^([a-zA-ZñÑáéíóúÁÉÍÓÚ_-])+((\s*)+([a-zA-ZñÑáéíóúÁÉÍÓÚ_-]*)*)+$/',
            'cedula_pa1'       => 'digits:10|unique:datos_padres,cedula_pa',
            'lugar_trabajo1'   => 'regex:/^([a-zA-ZñÑáéíóúÁÉÍÓÚ_-])+((\s*)+([a-zA-ZñÑáéíóúÁÉÍÓÚ_-]*)*)+$/',
            'direccion_pa1'    => 'regex:/^([a-zA-ZñÑáéíóúÁÉÍÓÚ_-])+((\s*)+([a-zA-ZñÑáéíóúÁÉÍÓÚ_-]*)*)+$/',
            'telefono_pa1'     => 'digits_between:10,11',
            'correo_pa1'       => 'unique:datos_padres,correo_pa',
            'nacionalidad_pa1' => 'regex:/^([a-zA-ZñÑáéíóúÁÉÍÓÚ_-])+((\s*)+([a-zA-ZñÑáéíóúÁÉÍÓÚ_-]*)*)+$/',
            //
