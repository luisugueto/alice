...
@else
		...
		@else
			...
			@else
				...
				{!! Form::label('cursos','Cursos', ['class' => 'control-label'])!!}
				<div class="controls">
					{!! Form::select('id_curso',$cursos,$id_curso,['class' => 'form-control','required' => 'required', 'placeholder' => 'SELECCIONE' , 'title' => 'Seleccione un Curso', 'id' => 'id_curso','onchange' => 'seccion()']) !!}
				</div>
			</div>
				...
				<div class="control-group">
					{!! Form::label('seccion','Secciones', ['class' => 'control-label'])!!}
					<div class="controls">
						{!! Form::select('id_seccion',$secciones,null,['class' => 'form-control select', 'title' => 'Seleccione una sección a inscribir']) !!}}
					</div>
				</div>
