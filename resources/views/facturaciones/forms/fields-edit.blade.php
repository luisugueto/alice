	...
	<div class="span4">
		...
		<div class="form-group">
			...
			{!! Form::number('monto_pagar', null, ['class' => 'form-control','required' => 'required', 'placeholder' => '100', 'title' => 'Aqui debe colocar la cantidad a pagar o a abonar, la cual no debe ser mayor al monto de deuda', 'disabled' => 'disabled', 'min' => '1', 'max' => $facturacion->factura->total_monto])  !!}
		</div>
